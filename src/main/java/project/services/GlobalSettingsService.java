...
import project.dto.responseDto.GlobalSettingsDto;
import project.models.Enums.GlobalSetting;
import project.models.GlobalSettings;
import project.repositories.GlobalSettingsRepository;
...
public class GlobalSettingsService
{
    ...
    public GlobalSettingsDto getGlobalSettings(){
            ...
            globalSettingsList.forEach(globalSettings -> {
    ...
    public void addNewSettings(GlobalSettingsDto globalSettingsDto){
        ...
        globalSettingsRepository
                .updateValue(globalSettingsDto.isMultiUserMode(), String.valueOf(GlobalSetting.MULTIUSER_MODE));
        globalSettingsRepository
                .updateValue(globalSettingsDto.isPostPreModeration(), String.valueOf(GlobalSetting.POST_PREMODERATION));
        globalSettingsRepository
                .updateValue(globalSettingsDto.isStatisticIsPublic(),
